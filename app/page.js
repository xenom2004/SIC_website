  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section class="text-black z-10">
            <div class="container mx-auto px-15 py-16"> 
              <h1 class="text-5xl font-bold mb-4" role="heading" aria-level="1">Sophisticated Instrumentation Center</h1>
