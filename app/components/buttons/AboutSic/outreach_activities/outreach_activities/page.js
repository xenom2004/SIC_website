...
const aboug = [
  {
    ...
    second: "Dr. Giddings has a Doctoral degree in semiconductor spintronics from the University of Nottingham. He is a member of the Institute of Physics (IOP) and a Fellow of the Royal Society of Arts, Manufactures and Commerce (RSA).",
    third: "Team SIC Organized a session about “Atom Prob Tomography and Its Application.”",
  ...
  },
  {
    ...
    second: "Prof. Dr. Volker Epping is the President of Leibniz Universität Hannover (since 2015).",
    third: "He is also the Vice President of the university alliance TU9 and deputy spokesman for the universities in the German Rectors’ Conference.",
  ...
  },
  {
    ...
    first: "Dr. A D Giddings visit.",
    second: "Dr. Giddings has a Doctoral degree in semiconductor spintronics from the University of Nottingham. He is a member of the Institute of Physics (IOP) and a Fellow of the Royal Society of Arts, Manufactures and Commerce (RSA).",
    third: "Dr. Giddings has a Doctoral degree in semiconductor spintronics from the University of Nottingham. He is a member of the Institute of Physics (IOP) and a Fellow of the Royal Society of Arts, Manufactures and Commerce (RSA).",
  ...
  },
  {
    ...
    second: "Students of JNV Ghattiya, Ujjain, visit as “Ek Bharat Shresht Bharat Abhiyan,”",
    third: "",
