    ...
    >
      <Link href="/instruments">
        <div
          ...
          className="text-white  bg-blue-780 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          About SIC
        </div>
      </Link>
