    ...
    <footer className="text-gray-300 bg-gray-800 body-font mt-0">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-wrap">
          <div className="lg:w-1/4 md:w-1/2 w-full">
            ...
            <p className="leading-relaxed">{translate("temp47")}</p>
            <p className="leading-relaxed">
            {translate("temp48")}  
            </p>
            <p className="leading-relaxed">{translate("temp49")}</p>
          </div>
      ...
      <div className="bg-gray-900">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          {translate("temp54")}  © 2024 SIC - A National Facility of IIT Indore
          </p>
