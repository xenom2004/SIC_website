export default function Footer() {
  return (
    <footer className="text-white bg-blue-900 body-font fixed bottom-0 w-full">
        ...
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">
              Sophisticated Instrumentation Center – A National FacilityIndian
              Institute of Technology Indore Khandwa Road, Simrol – 453552
              Phone: +91 (731) 6603311 3311/3543/3541
            </h2>
            <h2 className="cursor-pointer">Email: sic@iiti.ac.in</h2>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="bg-white mt-auto">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-center text-blue-900 text-sm sm:text-left">
