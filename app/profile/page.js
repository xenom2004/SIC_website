      ...
      <div className="w-full max-w-xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={`mb-4 ${handleDisable() == true ? "hidden" : ""}`}>
            ...
            <input
              type="text"
              id="studentDesignation"
              name="studentDesignation"
              value={profileData?.studentDesignation}
              onChange={handleChange}
              disabled={!isEditing}
              className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
            />
          ...
          <div className={`mb-4 `}>
            <label
              ...
              className="block text-sm font-medium text-gray-700"
            >
              Upload Profile Image <AddAPhotoSharp />{" "}
            </label>
            <input
              type="file"
              name="profile_image"
          ...
          <div className={`mb-4 `}>
            <label
              ...
              className="block text-sm font-medium text-gray-700"
            >
              Upload cover letter for verification of
              profile(Academic/commercial){" "}
            </label>
            <input
              type="file"
              name="cover_image"
              disabled={!isEditing}
              onChange={(e) => {
                handleImageChange(e, setcover_image);
              }}
              className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
              accept="image/*"
            ></input>
