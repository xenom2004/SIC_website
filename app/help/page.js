      ...
      <div className="w-full md:w-3/4 p-4">
        <section id="section1" className="mb-8">
          ...
          <p className="text-gray-800">
            ...
            dapibus, libero ac commodo hendrerit, neque est venenatis lectus,
            nec congue risus justo at justo."Lorem ipsum dolor sit amet,
        ...
        <section id="section2" className="mb-8">
          ...
          <p className="text-gray-800">
            Nulla facilisi. Vestibulum sodales lacinia suscipit. Phasellus at
            velit a lectus egestas commodo vel id velit. Mauris ut tincidunt
        ...
        <section id="section3">
          ...
          <p className="text-gray-800">
            Proin vehicula, sapien id fermentum dignissim, justo nisi finibus
            est, sit amet egestas nisi orci id est. Nunc convallis felis vitae
            pharetra pharetra. "Lorem ipsum dolor sit amet, consectetur
            adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
            exercitation ullamco laboris nisi ut aliquip ex ea commodo
            consequat. Duis aute irure dolor in reprehenderit in voluptate velit
